 ...
 */
export class HomebridgeGliderol implements DynamicPlatformPlugin {
  ...
  async discoverDevices() {
    ...
    for (const device of devices) {
      ...
      if (existingAccessory) {
        ...
        new HomebridgeGliderolAccessory(this, existingAccessory);
        ...
        // this is imported from `platformAccessory.ts`
        new HomebridgeGliderolAccessory(this, accessory);
